...
mixin _$SupplierController on SupplierControllerBase, Store {
  Computed<int>? _$totalServicesSelectedComputed;

  @override
  int get totalServicesSelected => (_$totalServicesSelectedComputed ??=
          Computed<int>(() => super.totalServicesSelected,
              name: 'SupplierControllerBase.totalServicesSelected'))
      .value;
  ...
  String toString() {
    return '''
totalServicesSelected: ${totalServicesSelected}
    ''';
  }
}
